...
namespace Post.Query.Domain.Aggregates;
...
public class PostAggregate : AggregateRoot
{
    ...
    public void LikePost()
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannot likean inactive post!");
        }
    ...
    public void EditComment(Guid commentId, string comment, string userName)
    {
        ...
        {
            throw new InvalidOperationException("You are not allowed to edit a comment that was made by an another user");
        }
    ...
    public void RemoveComment(Guid commentId, string userName)
    {
        ...
        if (!_comments[commentId].Item2.Equals(userName, StringComparison.CurrentCultureIgnoreCase))
        {
            throw new InvalidOperationException("You are not allowed to remove a comment that was made by an another user");
        }
